...
customElements.define('li-flips', class LiFlips extends LiElement {
    ...
    static get properties() {
        return {
            row: { type: Number, default: 5, save: true },
            column: { type: Number, default: 5, save: true },
            width: { type: Number, default: 100, save: true },
            height: { type: Number, default: 100, save: true },
            margin: { type: Number, default: 5, save: true },
            fontSize: { type: Number, default: 48, save: true },
            showSolved: { type: Boolean, default: true, save: true },
            autoClose: { type: Boolean, default: true, save: true },
            timeToClose: { type: Number, default: 750, save: true },
            babyMode: { type: Boolean, default: false, save: true },
            cards: { type: Array },
            card1: { type: Object },
            card2: { type: Object },
