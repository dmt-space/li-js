...
customElements.define('li-flips', class LiFlips extends LiElement {
    ...
    static get properties() {
        return {
            row: { type: Number, default: 5, save: true, category: 'props' },
            column: { type: Number, default: 5, save: true, category: 'props' },
            width: { type: Number, default: 100, save: true, category: 'props' },
            height: { type: Number, default: 100, save: true, category: 'props' },
            margin: { type: Number, default: 5, save: true, category: 'props' },
            fontSize: { type: Number, default: 48, save: true, category: 'props' },
            showSolved: { type: Boolean, default: true, save: true, category: 'props' },
            autoClose: { type: Boolean, default: true, save: true, category: 'props' },
            timeToClose: { type: Number, default: 750, save: true, category: 'props' },
            babyMode: { type: Boolean, default: false, save: true, category: 'props' },
            cards: { type: Array },
            card1: { type: Object },
            card2: { type: Object },
